...
3. Confirm that `repro/certificate_runtime.json` reports `ANA_G1` through `ANA_G6` and `ANA_GM` as `PASS`.
...
6. Read `paper/ANABELIAN_GEOMETRY_PREPRINT.md` with the super-repo interpretation in mind.
